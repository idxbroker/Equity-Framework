 ...
 * @package Equity\Sanitizer
 */
class EQUITY_Settings_Sanitizer {
	...
	function __construct() {
		...
		/**
		 * Fires when Equity_Settings_Sanitizer is initialized.
		 *
		 * @since 1.0
		 *
		 * @param Equity_Settings_Sanitizer $this The Equity_Settings_Sanitizer object.
		 */
		do_action_ref_array( 'equity_settings_sanitizer_init', array( &$this ) );
	 ...
	 *
	 * Array can be filtered via 'equity_available_sanitizer_filters' to let
	...
	function get_available_filters() {
		 ...
		 */
		return apply_filters( 'equity_available_sanitizer_filters', $default_filters );
 ...
 *
 * Use the 'equity_settings_sanitizer_init' action to be notified when this function is safe to use
 *
 * @since 1.0
 *
 * @uses EQUITY_Settings_Sanitizer::add_filter()
 *
 * @param string $filter The filter to call (see EQUITY_Settings_Sanitizer::$available_filters for options)
 ...
 * @return true
 */
function equity_add_option_filter( $filter, $option, $suboption = null ) {

	return EQUITY_Settings_Sanitizer::$instance->add_filter( $filter, $option, $suboption );

}

add_action( 'admin_init', 'equity_settings_sanitizer_init' );
/**
 * Instantiate the Sanitizer.
 *
 * @since 1.0
 */
function equity_settings_sanitizer_init() {

	new EQUITY_Settings_Sanitizer;
