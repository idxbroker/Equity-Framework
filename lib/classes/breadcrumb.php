 ...
 * If you change a private property expect that change to break Equity in the future.
 *
 * @since 1.0
 *
 * @package Equity\Breadcrumbs
 */
class EQUITY_Breadcrumb {
	...
	public function __construct() {
		...
		$this->args = array(
			...
			'sep'                     => ' / ',
			'list_sep'                => ', ',
			'prefix'                  => sprintf( '<nav %s>', equity_attr( 'breadcrumbs' ) ),
			'suffix'                  => '</nav>',
			'heirarchial_attachments' => true,
			'heirarchial_categories'  => true,
			'labels' => array(
				'prefix'    => __( 'You are here: ', 'equity' ),
				'author'    => __( 'Archives for ', 'equity' ),
				'category'  => __( 'Archives for ', 'equity' ),
				'tag'       => __( 'Archives for ', 'equity' ),
				'date'      => __( 'Archives for ', 'equity' ),
				'search'    => __( 'Search for ', 'equity' ),
				'tax'       => __( 'Archives for ', 'equity' ),
				'post_type' => __( 'Archives for ', 'equity' ),
				'404'       => __( 'Not found: ', 'equity' )
			)
		);
	...
	public function get_output( $args = array() ) {
		...
		/**
		 * Filter the Equity breadcrumb arguments.
		 *
		 * @since 1.0
		 *
		 * @param array $args {
		 ...
		 * }
		 */
		$this->args = apply_filters( 'equity_breadcrumb_args', wp_parse_args( $args, $this->args ) );
	...
	protected function build_crumbs() {
		...
		/**
		 * Filter the Equity breadcrumbs.
		 *
		 * @since 1.0
		 *
		 * @param string $crumbs HTML markup for the breadcrumbs.
		 * @param array  $args   Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		$crumbs = apply_filters( 'equity_build_crumbs', $crumbs, $this->args );
	...
	protected function get_archive_crumb() {
		...
		/**
		 * Filter the Equity archive breadcrumb.
		 *
		 * @since 1.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_archive_crumb', $crumb, $this->args );
	...
	protected function get_single_crumb() {
		...
		/**
		 * Filter the Equity single breadcrumb.
		 *
		 * @since 1.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_single_crumb', $crumb, $this->args );
	...
	protected function get_home_crumb() {
		...
		/**
		 * Filter the Equity home breadcrumb.
		 *
		 * @since 1.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_home_crumb', $crumb, $this->args );
	...
	protected function get_blog_crumb() {
		...
		/**
		 * Filter the Equity blog posts breadcrumb.
		 *
		 * @since 1.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_blog_crumb', $crumb, $this->args );
	...
	protected function get_search_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_search_crumb', $crumb, $this->args );
	...
	protected function get_404_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_404_crumb', $crumb, $this->args );
	...
	protected function get_page_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_page_crumb', $crumb, $this->args );
	...
	protected function get_category_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_category_crumb', $crumb, $this->args );
	...
	protected function get_tag_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_tag_crumb', $crumb, $this->args );
	...
	protected function get_tax_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_tax_crumb', $crumb, $this->args );
	...
	protected function get_year_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_year_crumb', $crumb, $this->args );
	...
	protected function get_month_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_month_crumb', $crumb, $this->args );
	...
	protected function get_day_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Equity_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_day_crumb', $crumb, $this->args );
	...
	protected function get_author_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Equity_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_author_crumb', $crumb, $this->args );
	...
	protected function get_post_type_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		return apply_filters( 'equity_post_type_crumb', $crumb, $this->args );
	...
	protected function get_breadcrumb_link( $url, $title, $content, $sep = false ) {
		...
		$link = sprintf( '<li><a href="%s"%s>%s</a></li>', esc_attr( $url ), $title, esc_html( $content ) );
		 ...
		 * @param array  $args    Arguments used to generate the breadcrumbs. Documented in EQUITY_Breadcrumbs::get_output().
		 */
		$link = apply_filters( 'equity_breadcrumb_link', $link, $url, $title, $content, $this->args );
