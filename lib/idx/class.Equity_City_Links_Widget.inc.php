...
/**
 * Creates a widget that outputs a list of idx city links
 *
 * @package IDX
 * @subpackage Widgets
 * @see Equity_Idx_Api
 */
class Equity_City_Links_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
	 		'equity_city_links', // Base ID
			'Equity - IDX City Links', // Name
			array(
				'description' => __( 'Outputs a list of city links', 'equity' ),
				'classname'   => 'equity-city-links-widget',
	...
	public function widget( $args, $instance ) {
		...
		if ( empty($instance['mls'] ) ) {
			echo 'MLS ID is invalid or does not exist in the database. Clear the IDX Cache in the Tools menu to refresh.';
		} else {
			echo $_idx->city_list_links($instance['city_list'], $instance['mls'], $instance['use_columns'], $instance['number_columns']);
		}
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['use_columns']    = empty( $new_instance['use_columns'] ) ? 0 : 1;
	 ...
	 *
	 * @see WP_Widget::form()
	 * @uses Equity_City_Links_Widget::city_list_options()
	...
	public function mls_options($instance) {
		...
		$approved_mls = $this->_idx->approved_mls();
