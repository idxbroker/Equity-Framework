 ...
 * @see Equity_Idx_Api
 */
class Equity_Idx_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
	 		'equity_idx_dashboard_widget', // Base ID
			__('Equity - IDX Dashboard Widget', 'equity' ), // Name
			array(
				'description' => __( 'Embed an IDX widget from the IDX dashboard', 'equity'),
				'classname'   => 'equity-idx-dashboard-widget'
			)
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			...
			Allow one hour for a widget to appear in this list after it has been created in the IDX dashboard.', 'equity' ); ?>
		</p>

		<p>
			<select class="widefat" id="<?php echo $this->get_field_id( 'widget' ); ?>" name="<?php echo $this->get_field_name( 'widget' ) ?>">
				<option <?php selected($instance['widget'], ''); ?> value=""><?php _e( 'Select a widget', 'equity' ); ?></option>
